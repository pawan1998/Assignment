...
SECRET_KEY = 'e-7vbrei5cs$fb3hqkz8dudkre^r4dh$1u%i$x=pz8uckpe7+j'
...
DJANGO_ENDESIVE = {
    'PDF_CERTIFICATE_PATH': 'required: C:\\Users\\chaturvedi_pa\\Downloads\\download.png',
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'assignment_site_app', 'static'),
)
